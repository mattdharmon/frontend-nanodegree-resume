...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfileComponent = __webpack_require__(163);
	var ContactComponent = __webpack_require__(164);
	var WorkComponent = __webpack_require__(165);
	var resumeData = __webpack_require__(166);
	...
	ReactDOM.render(React.createElement(ProfileComponent, data.profile), document.getElementById('profile'));

	ReactDOM.render(React.createElement(ContactComponent, data.profile.contact_info), document.getElementById('topContacts'));

	ReactDOM.render(React.createElement(ContactComponent, data.profile.contact_info), document.getElementById('footerContacts'));

	ReactDOM.render(React.createElement(WorkComponent, data.experience), document.getElementById('workExperienceContent'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(160)(module), (function() { return this; }()), __webpack_require__(161).setImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.setImmediate = __webpack_require__(162).nextTick;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContactItemComponent = React.createClass({
	  displayName: 'ContactItemComponent',
	...
	module.exports = React.createClass({
	  displayName: 'exports',
	  render: function render() {
	    var contactNodes = _.map(this.props, function (contact) {
	      return React.createElement(ContactItemComponent, { key: contact.id, type: contact.type, detail: contact.detail });
	    });
	    return React.createElement(
	      'ul',
	      { className: 'flex-box' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResponsibilityItemComponent = React.createClass({
	  displayName: 'ResponsibilityItemComponent',
	  render: function render() {
	    return React.createElement(
	      'li',
	      null,
	...
	var WorkItemComponent = React.createClass({
	  displayName: 'WorkItemComponent',
	  render: function render() {
	    var responsibilities = _.map(this.props.responsibilities, function (responsibility) {
	      return React.createElement(ResponsibilityItemComponent, _extends({ key: responsibility.id }, responsibility));
	    });
	    return React.createElement(
	      'div',
	...
	module.exports = React.createClass({
	  displayName: 'exports',
	  render: function render() {
	    var workNodes = _.map(this.props, function (work) {
	      return React.createElement(WorkItemComponent, _extends({ key: work.id }, work));
	    });
	    return React.createElement(
	      'div',
	      { id: 'workSection' },
